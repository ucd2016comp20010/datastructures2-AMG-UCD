...
* exceeds MIN_SECONDS.
*/
    public static int MIN_REPEATS = 1000; // repeat the execution at least this number of times
    public static int MAX_REPEATS = 1000000; // repeat the execution at least this number of times
